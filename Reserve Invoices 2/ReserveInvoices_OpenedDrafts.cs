...
namespace Reserve_Invoices_2
{
    ...
    public partial class ReserveInvoices_OpenedDrafts
    {
        ...
        public string U_IsCompleted { get; set; }
        public string U_ZEDS_TransactionID { get; set; }
        public string U_ZEDS_HasSignature { get; set; }
        public Nullable<int> U_ZEDS_SignActCode { get; set; }
        public string U_ZEDS_EmpComments { get; set; }
        public string U_ZEDS_ManComments { get; set; }
        public string U_ZED_EXTSTORE { get; set; }
        public string U_ZED_EXTORDERID { get; set; }
        public Nullable<int> U_ZED_EXTLINEID { get; set; }
        public string U_ZED_EXTSYNCHKEY { get; set; }
        public string U_ZED_BATCHID { get; set; }
        public string U_EposTID { get; set; }
        public string U_EposPoCode { get; set; }
        public string U_DeliveryScheduled { get; set; }
        public string U_V33SB_EXTERNALORDERID { get; set; }
        public string U_V33SB_EXTERNALORDERSRC { get; set; }
        public string U_InVoiceNo { get; set; }
        public Nullable<int> U_InvNo { get; set; }
    }
}
